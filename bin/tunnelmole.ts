...
Your server will then be accessible under a random URL like https://f38fg.tunnelmole.com which will be shown in the output.
This method is free and is a good way to get started.

Get a public URL that does not change: "tmole <port> as <subdomain>.tunnelmole.com"
For example you would run "tmole 80 as myapi.tunnelmole.com" (without the quotes) if your server runs on port 80 and you want to make it available with the domain myapi.tunnelmole.com
